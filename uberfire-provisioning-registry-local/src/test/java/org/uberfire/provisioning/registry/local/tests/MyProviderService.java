...
public class MyProviderService implements ProviderService {
    
    @Override
    public org.uberfire.provisioning.runtime.Runtime create( RuntimeConfiguration config ) throws ProvisioningException {
